                    ...
                    <main class="form-register">
                        <form action="/register" method="POST">
                           @csrf
                            ...
                            <div class="form-floating">
                                <input type="email" name="email" class="form-control mt-2" id="email" placeholder="Password">
                                <label for="email">Email</label>
                            </div>

                            <div class="form-floating">
                                <input type="number" name="no_hp" class="form-control mt-2" id="no_hp" placeholder="number">
